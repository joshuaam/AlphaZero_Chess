    ...
    def play_round(self):
        ...
        while checkmate == False and current_board.move_count <= 100:
            ...
            if current_board.player == 0:
                best_move, _ = UCT_search(current_board, 25, white, True)
            elif current_board.player == 1:
                best_move, _ = UCT_search(current_board, 25, black, True)
            ...
            if current_board.check_status() == True and current_board.in_check_possible_moves() == []:  # checkmate
                ...
                checkmate = True
        if value == 0:
            print("Draw in {} moves".format(current_board.move_count))
...
if __name__ == "__main__":
    ...
    current_net = "current_net_trained8_iter30.pth.tar"
    best_net = "current_net_trained8_iter1.pth.tar"
    ...
    # for p in processes:
    #     p.join()
    arena_obj = arena(current_chessnet, best_chessnet)
    arena_obj.evaluate(10, 0)
