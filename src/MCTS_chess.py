...
def UCT_search(game_state, num_reads, net, cuda=True):
...
def MCTS_self_play(chessnet, num_games, cpu):
    ...
    for idxx in range(0, num_games):
        ...
        while checkmate == False and current_board.move_count <= 100:
            ...
            best_move, root = UCT_search(current_board, 25, chessnet, False)
    ...
    print("wl_count: {}, time: {}, cpu: {}".format(wl_count, int(time.time() - st), cpu))
